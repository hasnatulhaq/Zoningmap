(this.webpackJsonpApp = this.webpackJsonpApp || []).push([
    [7], {
        121: function(t, o, e) {
            ...
            var n = e(3),
                ...
                b = function() {
                    ...
                    return t.prototype.componentDidLoad = function() {
                        ...
                        p((function() {
                            return Object(n.a)(t, void 0, void 0, (function() {
                                ...
                                return Object(n.c)(this, (function(n) {
                                    switch (n.label) {
                                        case 0:
                                            return t = Object(r.a)(window, "hybrid"), r.c.getBoolean("_testing") || e.e(55).then(e.bind(null, 170)).then((function(t) {
                                                return t.startTapClick(r.c)
                                            })), r.c.getBoolean("statusTap", t) && e.e(53).then(e.bind(null, 171)).then((function(t) {
                                                return t.startStatusTap()
                                            })), r.c.getBoolean("inputShims", u()) && e.e(42).then(e.bind(null, 172)).then((function(t) {
                                                return t.startInputShims(r.c)
                                            })), [4, Promise.resolve().then(e.bind(null, 30))];
                                        case 1:
                                            return o = n.sent(), r.c.getBoolean("hardwareBackButton", t) ? o.startHardwareBackButton() : o.blockHardwareBackButton(), "undefined" !== typeof window && e.e(51).then(e.bind(null, 173)).then((function(t) {
                                                return t.startKeyboardAssist(window)
                                            })), e.e(41).then(e.bind(null, 174)).then((function(t) {
                        ...
                        var t, o = Object(r.b)(this);
                        return Object(i.j)(i.c, {
                            class: (t = {}, t[o] = !0, t["ion-page"] = !0, t["force-statusbar-padding"] = r.c.getBoolean("_forceStatusbarPadding"), t)
                        })
            ...
            b.style = "html.plt-mobile ion-app{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}html.plt-mobile ion-app [contenteditable]{-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text}ion-app.force-statusbar-padding{--ion-safe-area-top:20px}";
            var g = function() {
                function t(t) {
                ...
                return t.prototype.render = function() {
                    var t, o = Object(r.b)(this);
                    return Object(i.j)(i.c, {
                        class: (t = {}, t[o] = !0, t["buttons-collapse"] = this.collapse, t)
                    })
                }, t
            }();
            g.style = {
            ...
            var h = function() {
                    function t(t) {
                        Object(i.o)(this, t), this.ionScrollStart = Object(i.g)(this, "ionScrollStart", 7), this.ionScroll = Object(i.g)(this, "ionScroll", 7), this.ionScrollEnd = Object(i.g)(this, "ionScrollEnd", 7), this.isScrolling = !1, this.lastScroll = 0, this.queued = !1, this.cTop = -1, this.cBottom = -1, this.isMainContent = !0, this.detail = {
                            scrollTop: 0,
                            scrollLeft: 0,
                            type: "scroll",
                            event: void 0,
                    ...
                    return t.prototype.connectedCallback = function() {
                        ...
                        var t = this;
                        this.fullscreen ? Object(i.h)((function() {
                        ...
                        var o = this,
                            e = Date.now(),
                            n = !this.isScrolling;
                        this.lastScroll = e, n && this.onScrollStart(), !this.queued && this.scrollEvents && (this.queued = !0, Object(i.h)((function(e) {
                            o.queued = !1, o.detail.event = t, m(o.detail, o.scrollEl, e, n), o.ionScroll.emit(o.detail)
                        })))
                        ...
                        return void 0 === e && (e = 0), Object(n.a)(this, void 0, void 0, (function() {
                            var i, r, a, s, l, c, d, b, u;
                            return Object(n.c)(this, (function(n) {
                                return i = this.scrollEl, e < 32 ? (null != o && (i.scrollTop = o), null != t && (i.scrollLeft = t), [2]) : (a = 0, s = new Promise((function(t) {
                                    return r = t
                                })), l = i.scrollTop, c = i.scrollLeft, d = null != o ? o - l : 0, b = null != t ? t - c : 0, u = function(t) {
                                    var o = Math.min(1, (t - a) / e) - 1,
                                        n = Math.pow(o, 3) + 1;
                                    0 !== d && (i.scrollTop = Math.floor(n * d + l)), 0 !== b && (i.scrollLeft = Math.floor(n * b + c)), n < 1 ? requestAnimationFrame(u) : r()
                        ...
                        this.isScrolling = !0, this.ionScrollStart.emit({
                            isScrolling: !0
                        }), this.watchDog && clearInterval(this.watchDog), this.watchDog = setInterval((function() {
                        ...
                        var t, o = this,
                            ...
                            b = n ? "main" : "div",
                            u = "ios" === c && r.c.getBoolean("experimentalTransitionShadow", !0);
                        return this.resize(), Object(i.j)(i.c, {
                            class: Object(a.a)(this.color, (t = {}, t[c] = !0, t["content-sizing"] = Object(a.c)("ion-popover", this.el), t.overscroll = d, t)),
                            style: {
                            ...
                            class: {
                                "inner-scroll": !0, "scroll-x": s, "scroll-y": l, overscroll: (s || l) && d
                            },
                            ref: function(t) {
                                return o.scrollEl = t
                            },
                            ...
                            part: "scroll"
                        }, Object(i.j)("slot", null)), u ? Object(i.j)("div", {
                            class: "transition-effect"
                        }, Object(i.j)("div", {
                            class: "transition-cover"
                        }), Object(i.j)("div", {
                            class: "transition-shadow"
                        })) : null, Object(i.j)("slot", {
                            name: "fixed"
                        }))
                    }, Object.defineProperty(t.prototype, "el", {
                        get: function() {
                ...
                f = function(t) {
                    ...
                    return e || function(t) {
                        return t.parentElement ? t.parentElement : t.parentNode && t.parentNode.host ? t.parentNode.host : null
                    }(t)
                },
                m = function(t, o, e, n) {
                    var i = t.currentX,
            ...
            var v = function() {
                ...
                return t.prototype.render = function() {
                    ...
                    return Object(i.j)(i.c, {
                        role: "contentinfo",
                        class: (t = {}, t[o] = !0, t["footer-" + o] = !0, t["footer-translucent"] = e, t["footer-translucent-" + o] = e, t)
                    }, "ios" === o && e && Object(i.j)("div", {
                    ...
                    Object(i.f)((function() {
                        ...
                        ! function(t, o, e) {
                            if (t[0].isIntersecting) {
                                var n = t[0].intersectionRatio > .9 || e <= 0 ? 0 : 100 * (1 - t[0].intersectionRatio) / 75;
                        ...
                        c || s > 0 && (d >= 5 || b >= 5) || (r.isIntersecting ? (j(o, !1), j(e)) : (0 === a.x && 0 === a.y || 0 !== a.width && 0 !== a.height) && i > 0 && (j(o), j(e, !1), k(o.toolbars[0])))
                    }))
                },
                j = function(t, o) {
                    void 0 === o && (o = !0), o ? t.el.classList.remove("header-collapse-condense-inactive") : t.el.classList.add("header-collapse-condense-inactive")
                },
                A = function(t, o, e) {
                    void 0 === t && (t = []), void 0 === o && (o = 1), void 0 === e && (e = !1), t.forEach((function(t) {
                        var n = t.ionTitleEl,
                            i = t.innerTitleEl;
                        n && "large" === n.size && (i.style.transition = e ? "all 0.2s ease-in-out" : "", i.style.transform = "scale3d(" + o + ", " + o + ", 1)")
                    }))
                },
                O = function() {
                    function t(t) {
                        Object(i.o)(this, t), this.collapsibleHeaderInitialized = !1, this.inheritedAttributes = {}, this.translucent = !1
                    }
                    return t.prototype.componentWillLoad = function() {
                        this.inheritedAttributes = Object(s.i)(this.el, ["role"])
                        ...
                        return Object(n.a)(this, void 0, void 0, (function() {
                            ...
                            return Object(n.c)(this, (function(n) {
                                switch (n.label) {
                                    case 0:
                                        return t = "condense" === this.collapse, (o = !(!t || "ios" !== Object(r.b)(this)) && t) || !this.collapsibleHeaderInitialized ? [3, 1] : (this.destroyCollapsibleHeader(), [3, 3]);
                                    case 1:
                                        return !o || this.collapsibleHeaderInitialized ? [3, 3] : (e = this.el.closest("ion-app,ion-page,.ion-page,page-inner"), a = e ? e.querySelector("ion-content") : null, Object(i.f)((function() {
                                            x("ion-title").size = "large", x("ion-back-button")
                        ...
                        return Object(n.a)(this, void 0, void 0, (function() {
                            var e, r, a, l, c, d = this;
                            return Object(n.c)(this, (function(n) {
                                switch (n.label) {
                                    case 0:
                                        return t && o ? "undefined" === typeof IntersectionObserver ? [2] : (e = this, [4, t.getScrollElement()]) : (console.error("ion-header requires a content to collapse, make sure there is an ion-content."), [2]);
                                    case 1:
                                        return e.scrollEl = n.sent(), r = o.querySelectorAll("ion-header"), this.collapsibleMainHeader = Array.from(r).find((function(t) {
                                            return "condense" !== t.collapse
                                        })), this.collapsibleMainHeader ? (a = w(this.collapsibleMainHeader), l = w(this.el), a && l ? (j(a, !1), a.toolbars.forEach((function(t) {
                                            k(t, 0)
                                        })), c = function(t) {
                                            y(t, a, l, d.scrollEl)
                                        }, this.intersectionObserver = new IntersectionObserver(c, {
                                            root: t,
                                            threshold: [.25, .3, .4, .5, .6, .7, .8, .9, 1]
                                        }), this.intersectionObserver.observe(l.toolbars[l.toolbars.length - 1].el), this.contentScrollCallback = function() {
                                            ! function(t, o, e) {
                                                Object(i.h)((function() {
                                                    var n = t.scrollTop,
                                                        r = Object(s.j)(1, 1 + -n / 500, 1.1);
                                                    null === e.querySelector("ion-refresher.refresher-native") && Object(i.f)((function() {
                                                        A(o.toolbars, r)
                                                    }))
                                                }))
                                            }(d.scrollEl, l, t)
                                        }, this.scrollEl.addEventListener("scroll", this.contentScrollCallback), Object(i.f)((function() {
                                            void 0 !== d.collapsibleMainHeader && d.collapsibleMainHeader.classList.add("header-collapse-main")
                                        })), this.collapsibleHeaderInitialized = !0, [2]) : [2]) : [2]
                                }
                            }))
                        }))
                    }, t.prototype.render = function() {
                        var t, o = this.translucent,
                            e = this.inheritedAttributes,
                            n = Object(r.b)(this),
                            a = this.collapse || "none";
                        return Object(i.j)(i.c, Object.assign({
                            role: "banner",
                            class: (t = {}, t[n] = !0, t["header-" + n] = !0, t["header-translucent"] = this.translucent, t["header-collapse-" + a] = !0, t["header-translucent-" + n] = this.translucent, t)
                        }, e), "ios" === n && o && Object(i.j)("div", {
            ...
            var S = function() {
                function t(t) {
                    Object(i.o)(this, t), this.ionNavWillLoad = Object(i.g)(this, "ionNavWillLoad", 7), this.ionNavWillChange = Object(i.g)(this, "ionNavWillChange", 3), this.ionNavDidChange = Object(i.g)(this, "ionNavDidChange", 3), this.gestureOrAnimationInProgress = !1, this.mode = Object(r.b)(this), this.animated = !0
                }
                return t.prototype.swipeHandlerChanged = function() {
                    ...
                    return Object(n.a)(this, void 0, void 0, (function() {
                        ...
                        return Object(n.c)(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    return t = function() {
                                        i.gestureOrAnimationInProgress = !0, i.swipeHandler && i.swipeHandler.onStart()
                                    }, o = this, [4, e.e(0).then(e.bind(null, 169))];
                                case 1:
                                    return o.gesture = n.sent().createSwipeBackGesture(this.el, (function() {
                                        return !i.gestureOrAnimationInProgress && !!i.swipeHandler && i.swipeHandler.canStart()
                                    }), (function() {
                                        return t()
                                    }), (function(t) {
                                        return i.ani && i.ani.progressStep(t)
                                    }), (function(t, o, e) {
                                        if (i.ani) {
                                            i.ani.onFinish((function() {
                                                i.gestureOrAnimationInProgress = !1, i.swipeHandler && i.swipeHandler.onEnd(t)
                                            }), {
                                                oneTimeCallback: !0
                                            });
                                            var n = t ? -.001 : .001;
                                            t ? n += Object(l.a)([0, 0], [.32, .72], [0, 1], [1, 1], o)[0] : (i.ani.easing("cubic-bezier(1, 0, 0.68, 0.28)"), n += Object(l.a)([0, 0], [1, 0], [.68, .28], [1, 1], o)[0]), i.ani.progressEnd(t ? 1 : 0, n, e)
                                        } else i.gestureOrAnimationInProgress = !1
                                    })), this.swipeHandlerChanged(), [2]
                            }
                        }))
                    }))
                    ...
                    return Object(n.a)(this, void 0, void 0, (function() {
                        ...
                        return Object(n.c)(this, (function(n) {
                            switch (n.label) {
                                ...
                                case 2:
                                    return n.trys.push([2, 4, , 5]), [4, this.transition(t, o, e)];
                                case 3:
                                    return r = n.sent(), [3, 5];
                                case 4:
                    ...
                    return Object(n.a)(this, void 0, void 0, (function() {
                        ...
                        return Object(n.c)(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    return this.activeComponent === t ? [2, !1] : (i = this.activeEl, [4, Object(c.a)(this.delegate, this.el, t, ["ion-page", "ion-page-invisible"], o)]);
                                case 1:
                                    return r = n.sent(), this.activeComponent = t, this.activeEl = r, [4, this.commit(r, i, e)];
                                case 2:
                    ...
                    return void 0 === e && (e = {}), Object(n.a)(this, void 0, void 0, (function() {
                        var i, a, s, l, c, b = this;
                        return Object(n.c)(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    return o === t ? [2, !1] : (this.ionNavWillChange.emit(), a = (i = this).el, s = i.mode, l = this.animated && r.c.getBoolean("animated", !0), c = e.animationBuilder || this.animation || r.c.get("navAnimation"), [4, Object(d.h)(Object.assign(Object.assign({
                                        mode: s,
                                        animated: l,
                                        enteringEl: t,
                                        leavingEl: o,
                                        ...
                                        progressCallback: e.progressAnimation ? function(t) {
                                            void 0 === t || b.gestureOrAnimationInProgress ? b.ani = t : (b.gestureOrAnimationInProgress = !0, t.onFinish((function() {
                                                b.gestureOrAnimationInProgress = !1, b.swipeHandler && b.swipeHandler.onEnd(!1)
                                            }), {
                                                oneTimeCallback: !0
                                            }), t.progressEnd(0, 0, 0))
                                        } : void 0
                    ...
                    return Object(n.a)(this, void 0, void 0, (function() {
                        ...
                        return Object(n.c)(this, (function(e) {
                            switch (e.label) {
                                case 0:
                                    return t = this.waitPromise, this.waitPromise = new Promise((function(t) {
                                        return o = t
                                    })), void 0 === t ? [3, 2] : [4, t];
                                case 1:
                                    e.sent(), e.label = 2;
            ...
            S.style = ":host{left:0;right:0;top:0;bottom:0;position:absolute;contain:layout size style;overflow:hidden;z-index:0}";
            var z = function() {
                function t(t) {
                    Object(i.o)(this, t), this.ionStyle = Object(i.g)(this, "ionStyle", 7)
                }
                return t.prototype.sizeChanged = function() {
                    this.emitStyle()
                }, t.prototype.connectedCallback = function() {
                    this.emitStyle()
                }, t.prototype.emitStyle = function() {
                    var t, o = this.getSize();
                    ...
                    var t, o = Object(r.b)(this),
                        e = this.getSize();
                    return Object(i.j)(i.c, {
                        class: Object(a.a)(this.color, (t = {}, t[o] = !0, t["title-" + e] = !0, t["title-rtl"] = "rtl" === document.dir, t))
                    }, Object(i.j)("div", {
                        class: "toolbar-title"
                    }, Object(i.j)("slot", null)))
                }, Object.defineProperty(t.prototype, "el", {
            ...
            var E = function() {
                ...
                return t.prototype.componentWillLoad = function() {
                    ...
                    var t, o = Object(r.b)(this),
                        e = {};
                    return this.childrenStyles.forEach((function(t) {
                        Object.assign(e, t)
                    })), Object(i.j)(i.c, {
                        class: Object.assign(Object.assign({}, e), Object(a.a)(this.color, (t = {}, t[o] = !0, t["in-toolbar"] = Object(a.c)("ion-toolbar", this.el), t)))
                    }, Object(i.j)("div", {
                    ...
                    }, Object(i.j)("slot", null)), Object(i.j)("slot", {
                        name: "primary"
                    }), Object(i.j)("slot", {
                        name: "end"
                    })))
            ...
            var n = e(3),
                ...
                l = function(t, o, e, i) {
                    return Object(n.a)(void 0, void 0, void 0, (function() {
                        var r;
                        return Object(n.c)(this, (function(n) {
                            return null != t && "#" !== t[0] && !s.test(t) && (r = document.querySelector("ion-router")) ? (null != o && o.preventDefault(), [2, r.push(t, e, i)]) : [2, !1]
                        }))
                    }))
                }
        },
                        ...
                        return Object(n.c)(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    ...
                                    if ("string" !== typeof e && !(e instanceof HTMLElement)) throw new Error("framework delegate is missing");
                                    return s = "string" === typeof e ? o.ownerDocument && o.ownerDocument.createElement(e) : e, r && r.forEach((function(t) {
                                        return s.classList.add(t)
                                    })), a && Object.assign(s, a), o.appendChild(s), [4, new Promise((function(t) {
...
//# sourceMappingURL=7.fdd9a55d.chunk.js.map