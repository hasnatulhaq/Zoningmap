import {
    G as GESTURE_CONTROLLER
} from "./gesture-controller-31cb6bb9.js";
export {
    G as GESTURE_CONTROLLER
}
from "./gesture-controller-31cb6bb9.js";
...
var createPointerEvents = function(e, r, t, a, n) {
    ...
    var d = function(a) {
        ...
        if (!s) {
            s = addEventListener(a.target, "touchend", p, n)
        }
        if (!v) {
            v = addEventListener(a.target, "touchcancel", p, n)
        }
    };
    var m = function(a) {
        if (l > Date.now()) {
...
var createGesture = function(e) {
    ...
    var D = createPointerEvents(i.el, g, y, T, {
        capture: false,
        passive: d
    });
    var P = function() {
