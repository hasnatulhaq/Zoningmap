...
import {
    b as getIonMode,
    c as config
} from "./ionic-global-63a97a32.js";
import {
    r as raf
} from "./helpers-dd7e4b7b.js";
import {
    c as createColorClasses,
    h as hostContext,
    o as openURL
} from "./theme-ff3fc52f.js";
...
var Item = function() {
    ...
    t.prototype.itemStyle = function(t) {
        ...
        if (!r && Object.keys(o).length !== Object.keys(n).length) {
            r = true
        }
        if (r) {
    ...
    t.prototype.componentDidUpdate = function() {
        var t = this;
        var i = this.getFirstInput();
        if (i && !this.clickListener) {
    ...
    t.prototype.setMultipleInputs = function() {
        ...
        var i = this.el.querySelectorAll("ion-input, ion-range, ion-searchbar, ion-segment, ion-textarea, ion-toggle");
        var e = this.el.querySelectorAll("ion-anchor, ion-button, a, button");
    ...
    t.prototype.delegateFocus = function(t, i) {
        var e = t.target.tagName === "ION-ITEM";
        var o = false;
        if (document.activeElement) {
            o = i.querySelector("input, textarea") === document.activeElement
        }
        if (e && o) {
            i.fireFocusEvents = false;
            i.setBlur();
            i.setFocus();
            raf((function() {
                i.fireFocusEvents = true
            }))
        }
    };
    t.prototype.render = function() {
        ...
        var i = this,
            ...
            c = i.routerDirection;
        var p = {};
        var b = getIonMode(this);
        var f = this.isClickable();
        var x = this.canActivate();
        var u = f ? s === undefined ? "button" : "a" : "div";
        var v = u === "button" ? {
            type: this.type
        } : {
            download: n,
        ...
        var k = e !== undefined ? e : b === "ios" && f;
        this.itemStyles.forEach((function(t) {
            Object.assign(p, t)
        }));
        var y = l || p["item-interactive-disabled"] ? "true" : null;
        return h(Host, {
            "aria-disabled": y,
            class: Object.assign(Object.assign(Object.assign({}, p), r), createColorClasses(this.color, (t = {
                item: true
            }, t[b] = true, t["item-lines-" + a] = a !== undefined, t["item-disabled"] = l, t["in-list"] = hostContext("ion-list", this.el), t["item-multiple-inputs"] = this.multipleInputs, t["ion-activatable"] = x, t["ion-focusable"] = true, t)))
        }, h(u, Object.assign({}, v, {
            class: "item-native",
            part: "native",
            disabled: l
        ...
        })), x && b === "md" && h("ion-ripple-effect", null)), h("div", {
...
var ItemDivider = function() {
    ...
    t.prototype.render = function() {
        ...
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[i] = true, t["item-divider-sticky"] = this.sticky, t["item"] = true, t))
        }, h("slot", {
            name: "start"
        }), h("div", {
...
var ItemGroup = function() {
    ...
    t.prototype.render = function() {
        ...
        return h(Host, {
            role: "group",
            class: (t = {}, t[i] = true, t["item-group-" + i] = true, t["item"] = true, t)
        })
    };
    return t
}();
...
var Label = function() {
    ...
    t.prototype.emitColor = function() {
        ...
        this.ionColor.emit((t = {
            "item-label-color": i !== undefined
        }, t["ion-color-" + i] = i !== undefined, t))
    };
    ...
    t.prototype.render = function() {
        ...
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[e] = true, t["in-item-color"] = hostContext("ion-item.ion-color", this.el), t["label-" + i] = i !== undefined, t["label-no-animate"] = this.noAnimate, t))
        })
    };
    Object.defineProperty(t.prototype, "el", {
        get: function() {
...
var List = function() {
    ...
    t.prototype.render = function() {
        ...
        var e = this,
            ...
            n = e.inset;
        return h(Host, {
            class: (t = {}, t[i] = true, t["list-" + i] = true, t["list-inset"] = n, t["list-lines-" + o] = o !== undefined, t["list-" + i + "-lines-" + o] = o !== undefined, t)
        })
    };
    Object.defineProperty(t.prototype, "el", {
        get: function() {
...
var ListHeader = function() {
    ...
    t.prototype.render = function() {
        ...
        var e = getIonMode(this);
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[e] = true, t["list-header-lines-" + i] = i !== undefined, t))
        }, h("div", {
...
var Note = function() {
    ...
    t.prototype.render = function() {
        ...
        var i = getIonMode(this);
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[i] = true, t))
        }, h("slot", null))
    };
    return t
}();
...
var SkeletonText = function() {
    ...
    t.prototype.render = function() {
        var t;
        var i = this.animated && config.getBoolean("animated", true);
        var e = hostContext("ion-avatar", this.el) || hostContext("ion-thumbnail", this.el);
        var o = getIonMode(this);
        return h(Host, {
            class: (t = {}, t[o] = true, t["skeleton-text-animated"] = i, t["in-media"] = e, t)
        }, h("span", null, " "))
    };
    Object.defineProperty(t.prototype, "el", {
        get: function() {
...
export {
    Item as ion_item, ItemDivider as ion_item_divider, ItemGroup as ion_item_group, Label as ion_label, List as ion_list, ListHeader as ion_list_header, Note as ion_note, SkeletonText as ion_skeleton_text
};