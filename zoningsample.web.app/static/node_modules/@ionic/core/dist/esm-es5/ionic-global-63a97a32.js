...
var configFromURL = function(t) {
    var e = {};
    t.location.search.slice(1).split("&").map((function(t) {
        return t.split("=")
    })).map((function(t) {
        var e = t[0],
            n = t[1];
        return [decodeURIComponent(e), decodeURIComponent(n)]
    })).filter((function(t) {
        var e = t[0];
        return startsWith(e, IONIC_PREFIX)
    })).map((function(t) {
        var e = t[0],
            n = t[1];
        return [e.slice(IONIC_PREFIX.length), n]
    })).forEach((function(t) {
        var n = t[0],
            i = t[1];
        e[n] = i
...
var initialize = function(t) {
    ...
    setupPlatforms(n);
    var r = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, configFromSession(n)), {
        persistConfig: false
    }), i.config), configFromURL(n)), t);
    config.reset(r);
    ...
    var o = function(t) {
        return t.tagName && t.tagName.startsWith("ION-")
    };
    var a = function(t) {
        return ["ios", "md"].includes(t)
    };
    setMode((function(t) {
        while (t) {
            var e = t.mode || t.getAttribute("mode");
            if (e) {
                if (a(e)) {
                    return e
                } else if (o(t)) {
...
export {
    isPlatform as a, getIonMode as b, config as c, getPlatforms as g, initialize as i
};