    ...
    if (r) {
        r.map((function(r) {
            var n = r[0],
                a = r[1],
                o = r[2];
            var s = getHostListenerTarget(e, n);
            var i = hostListenerProxy(t, o);
            var l = hostListenerOpts(n);
            plt.ael(s, a, i, l);
...
var setAccessor = function(e, t, r, n, a, o) {
    if (r !== n) {
        ...
        if (t === "class") {
            ...
            l.remove.apply(l, $.filter((function(e) {
...
var updateElement = function(e, t, r, n) {
    ...
    var s = t.$attrs$ || EMPTY_OBJ; {
        for (n in o) {
            if (!(n in s)) {
                setAccessor(a, n, o[n], undefined, r, t.$flags$)
            }
        }
    }
    for (n in s) {
                    ...
                    if (isNodeLocatedInSlot(r, a)) {
                        ...
                        if (r["s-sr"]) {
                            relocateNodes.map((function(e) {
                                if (isNodeLocatedInSlot(e.$nodeToRelocate$, r["s-sn"])) {
                                    o = relocateNodes.find((function(e) {
                                        return e.$nodeToRelocate$ === r
                                    }));
                                    if (o && !e.$slotRefNode$) {
        ...
        return __generator(this, (function(f) {
            switch (f.label) {
                ...
                case 2:
                    ...
                    if (!!styles.has(i)) return [3, 5];
                    l = createTime("registerStyles", r.$tagName$);
                    if (!(r.$flags$ & 8)) return [3, 4];
                    return [4,
                        import ("./shadow-css-a3f00b33.js").then((function(e) {
                            return e.scopeCss(s, i, false)
                        }))
                    ];
                case 3:
                    s = f.sent();
...
var bootstrapLazy = function(e, t) {
    ...
    e.map((function(e) {
        return e[1].map((function(t) {
            ...
            r.$lazyBundleId$ = e[0];
            if (!a.includes(s) && !o.get(s)) {
                n.push(s);
                o.define(s, proxyComponent(i, r, 1))
            }
        }))
    })); {
...
var loadModule = function(e, t, r) {
    ...
    return import ("./" + a + ".entry.js" + "").then((function(e) {
        {
            cmpModules.set(a, e)
        }
        return e[n]
...
export {
    Build as B, CSS as C, Host as H, NAMESPACE as N, promiseResolve as a, bootstrapLazy as b, writeTask as c, doc as d, createEvent as e, readTask as f, getMode as g, h, getElement as i, forceUpdate as j, getAssetPath as k, plt as p, registerInstance as r, setMode as s, win as w
};