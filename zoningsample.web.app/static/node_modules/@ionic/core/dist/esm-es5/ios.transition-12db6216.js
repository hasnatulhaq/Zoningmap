import {
    c as createAnimation
} from "./animation-096c6391.js";
import {
    g as getIonPageElement
} from "./index-931440b1.js";
...
var animateBackButton = function(e, t, a, r, o, n) {
    ...
    var m = [{
        offset: 0,
        opacity: 0,
        transform: "translate3d(" + l + ", " + (o.top - 40) + "px, 0) scale(2.1)"
    }, {
        offset: 1,
        opacity: 1,
        transform: "translate3d(" + s + ", " + (n.top - 46) + "px, 0) scale(1)"
    }];
    var v = [{
        offset: 0,
        opacity: 1,
    ...
    var y = [{
        offset: 0,
        opacity: 0,
        transform: "translate3d(" + c + ", " + (n.top - 41) + "px, 0) scale(0.6)"
    }, {
        offset: 1,
        opacity: 1,
        transform: "translate3d(" + c + ", " + (n.top - 46) + "px, 0) scale(1)"
    }];
    var u = [{
        offset: 0,
        opacity: 1,
...
var animateLargeTitle = function(e, t, a, r, o, n) {
    ...
    var f = [{
        offset: 0,
        opacity: 0,
        transform: "translate3d(" + s + ", " + (n.top - 4) + "px, 0) scale(0.49)"
    }, {
        offset: .1,
        opacity: 0
    }, {
        offset: 1,
        opacity: 1,
        transform: "translate3d(0, " + (o.top - 2) + "px, 0) scale(1)"
    }];
    var d = [{
        offset: 0,
        opacity: .99,
        ...
        offset: 1,
        opacity: 0,
        transform: "translate3d(" + s + ", " + (n.top - 4) + "px, 0) scale(0.5)"
    }];
    var m = a ? f : d;
    ...
    p.beforeStyles((i = {
        ...
        display: "",
        position: "relative"
    }, i[c] = l, i)).beforeAddWrite((function() {
        r.style.setProperty("display", "none")
    })).afterAddWrite((function() {
        r.style.setProperty("display", "");
    ...
    try {
        ...
        if (v) {
            ...
            if (A) {
                ...
                x.addElement(S).beforeClearStyles([r]).fromTo(r, 0, .1);
                E.addElement(T).beforeClearStyles([r]).fromTo(r, .03, .7);
                h.addAnimation([x, E]);
                b.addAnimation([h])
            }
        }
        var q = f.querySelector("ion-header.header-collapse-condense");
        var X = createLargeTitleTransition(u, l, m, f, d),
            C = X.forward,
            k = X.backward;
        y.forEach((function(e) {
            ...
            u.addAnimation(t);
            var a = createAnimation();
            a.addElement(e.querySelector("ion-title"));
            var o = createAnimation();
            var i = Array.from(e.querySelectorAll("ion-buttons,[menuToggle]"));
            var f = e.closest("ion-header");
            var d = f && f.classList.contains("header-collapse-condense-inactive");
            var v;
            if (m) {
            ...
            o.addElement(v);
            var p = createAnimation();
            p.addElement(e.querySelectorAll(":scope > *:not(ion-title):not(ion-buttons):not([menuToggle])"));
            var y = createAnimation();
            y.addElement(shadow(e).querySelector(".toolbar-background"));
            var b = createAnimation();
            var g = e.querySelector("ion-back-button");
            if (g) {
                b.addElement(g)
            }
            t.addAnimation([a, o, p, y, b]);
            o.fromTo(r, .01, 1);
            p.fromTo(r, .01, 1);
            if (m) {
                if (!d) {
                    a.fromTo("transform", "translateX(" + c + ")", "translateX(" + n + ")").fromTo(r, .01, 1)
                }
                p.fromTo("transform", "translateX(" + c + ")", "translateX(" + n + ")");
                b.fromTo(r, .01, 1)
            } else {
                if (!q) {
                    a.fromTo("transform", "translateX(" + s + ")", "translateX(" + n + ")").fromTo(r, .01, 1)
                }
                p.fromTo("transform", "translateX(" + s + ")", "translateX(" + n + ")");
                y.beforeClearStyles([r, "transform"]);
                var A = f === null || f === void 0 ? void 0 : f.translucent;
                if (!A) {
                    y.fromTo(r, .01, "var(--opacity)")
                } else {
                    y.fromTo("transform", l ? "translateX(-100%)" : "translateX(100%)", "translateX(0px)")
                }
                if (!C) {
                    b.fromTo(r, .01, 1)
                }
                if (g && !C) {
                    var S = createAnimation();
                    S.addElement(shadow(g).querySelector(".button-text")).fromTo("transform", l ? "translateX(-100px)" : "translateX(100px)", "translateX(0px)");
                    t.addAnimation(S)
                }
            }
        }));
        if (d) {
            ...
            if (B) {
                ...
                if (I) {
                    ...
                    D.addElement(N).beforeClearStyles([r]).fromTo(r, .1, 0);
                    O.addElement(W).beforeClearStyles([r]).fromTo(r, .7, .03);
                    j.addAnimation([D, O]);
                    w.addAnimation([j])
                }
            }
            L.forEach((function(e) {
                ...
                var s = e.querySelectorAll("ion-buttons,[menuToggle]");
                var f = e.closest("ion-header");
                var d = f && f.classList.contains("header-collapse-condense-inactive");
                var v = Array.from(s).filter((function(e) {
                    var t = e.classList.contains("buttons-collapse");
                    return t && !d || !t
                }));
                i.addElement(v);
                var p = createAnimation();
                var y = e.querySelectorAll(":scope > *:not(ion-title):not(ion-buttons):not([menuToggle])");
                if (y.length > 0) {
                    p.addElement(y)
                }
                var b = createAnimation();
                b.addElement(shadow(e).querySelector(".toolbar-background"));
                var g = createAnimation();
                var A = e.querySelector("ion-back-button");
                if (A) {
                    g.addElement(A)
                }
                t.addAnimation([a, i, p, g, b]);
                u.addAnimation(t);
                g.fromTo(r, .99, 0);
                i.fromTo(r, .99, 0);
                p.fromTo(r, .99, 0);
                if (m) {
                    if (!d) {
                        a.fromTo("transform", "translateX(" + n + ")", l ? "translateX(-100%)" : "translateX(100%)").fromTo(r, .99, 0)
                    }
                    p.fromTo("transform", "translateX(" + n + ")", l ? "translateX(-100%)" : "translateX(100%)");
                    b.beforeClearStyles([r, "transform"]);
                    var S = f === null || f === void 0 ? void 0 : f.translucent;
                    if (!S) {
                        b.fromTo(r, "var(--opacity)", 0)
                    } else {
                        b.fromTo("transform", "translateX(0px)", l ? "translateX(-100%)" : "translateX(100%)")
                    }
                    if (A && !k) {
                        var T = createAnimation();
                        T.addElement(shadow(A).querySelector(".button-text")).fromTo("transform", "translateX(" + n + ")", "translateX(" + ((l ? -124 : 124) + "px") + ")");
                        t.addAnimation(T)
                    }
                } else {
                    if (!d) {
                        a.fromTo("transform", "translateX(" + n + ")", "translateX(" + c + ")").fromTo(r, .99, 0).afterClearStyles([o, r])
                    }
                    p.fromTo("transform", "translateX(" + n + ")", "translateX(" + c + ")").afterClearStyles([o, r]);
                    g.afterClearStyles([r]);
                    a.afterClearStyles([r]);
                    i.afterClearStyles([r])
                }
            }))
        }
        return u
