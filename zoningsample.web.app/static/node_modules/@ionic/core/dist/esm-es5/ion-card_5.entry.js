...
var Card = function() {
    ...
    t.prototype.renderCard = function(t) {
        ...
        var o = this,
            ...
            n = o.routerAnimation,
            a = o.routerDirection;
        var e = r ? i === undefined ? "button" : "a" : "div";
        var s = e === "button" ? {
            type: this.type
        } : {
        ...
        return h(e, Object.assign({}, s, {
            class: "card-native",
            part: "native",
            disabled: this.disabled,
            onClick: function(t) {
                return openURL(i, t, a, n)
            }
        }), h("slot", null), r && t === "md" && h("ion-ripple-effect", null))
    };
    t.prototype.render = function() {
        var t;
        var r = getIonMode(this);
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[r] = true, t["card-disabled"] = this.disabled, t["ion-activatable"] = this.isClickable(), t))
        }, this.renderCard(r))
    };
    return t
}();
...
var CardContent = function() {
    ...
    t.prototype.render = function() {
        ...
        var r = getIonMode(this);
        return h(Host, {
            class: (t = {}, t[r] = true, t["card-content-" + r] = true, t)
        })
    };
    return t
}();
...
var CardHeader = function() {
    ...
    t.prototype.render = function() {
        ...
        var r = getIonMode(this);
        return h(Host, {
            class: createColorClasses(this.color, (t = {
...
export {
    Card as ion_card, CardContent as ion_card_content, CardHeader as ion_card_header, CardSubtitle as ion_card_subtitle, CardTitle as ion_card_title
};