...
import {
    j as clamp,
    i as inheritAttributes
} from "./helpers-dd7e4b7b.js";
import {
    g as getTimeGivenProgression
} from "./cubic-bezier-eea9a7a9.js";
import {
    a as attachComponent,
    d as detachComponent
} from "./framework-delegate-4392cd63.js";
import {
    t as transition
...
var App = function() {
            ...
            rIC((function() {
                return __awaiter(t, void 0, void 0, (function() {
                    ...
                    return __generator(this, (function(e) {
                        switch (e.label) {
                            case 0:
                                t = isPlatform(window, "hybrid");
                                if (!config.getBoolean("_testing")) {
                                    import ("./tap-click-cc1ae2b2.js").then((function(t) {
                                        return t.startTapClick(config)
                                    }))
                                }
                                if (config.getBoolean("statusTap", t)) {
                                    import ("./status-tap-5c3a5bca.js").then((function(t) {
                                        return t.startStatusTap()
                                    }))
                                }
                                if (config.getBoolean("inputShims", needInputShims())) {
                                    import ("./input-shims-73f15161.js").then((function(t) {
                                        return t.startInputShims(config)
                                    }))
                                }
                                return [4,
                            ...
                            case 1:
                                o = e.sent();
                                if (config.getBoolean("hardwareBackButton", t)) {
                                    o.startHardwareBackButton()
                                } else {
                                    o.blockHardwareBackButton()
                                }
                                if (typeof window !== "undefined") {
                                    import ("./keyboard-5742b5da.js").then((function(t) {
                                        return t.startKeyboardAssist(window)
                                    }))
                                }
                                import ("./focus-visible-f4ad4f1a.js").then((function(t) {
    ...
    t.prototype.render = function() {
        ...
        return h(Host, {
            class: (t = {}, t[o] = true, t["ion-page"] = true, t["force-statusbar-padding"] = config.getBoolean("_forceStatusbarPadding"), t)
        })
    };
...
var Content = function() {
    ...
    t.prototype.shouldForceOverscroll = function() {
        ...
        var o = getIonMode(this);
        return t === undefined ? o === "ios" && isPlatform("ios") : t
    };
    ...
    t.prototype.render = function() {
        ...
        var l = n ? "main" : "div";
        var d = a === "ios" && config.getBoolean("experimentalTransitionShadow", true);
        this.resize();
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[a] = true, t["content-sizing"] = hostContext("ion-popover", this.el), t["overscroll"] = s, t)),
            style: {
            ...
            class: {
                "inner-scroll": true, "scroll-x": r, "scroll-y": i, overscroll: (r || i) && s
            },
            ref: function(t) {
                return o.scrollEl = t
            },
...
var Header = function() {
            ...
            return __generator(this, (function(r) {
                switch (r.label) {
                    case 0:
                        ...
                        o = t && getIonMode(this) === "ios" ? t : false;
    ...
    t.prototype.render = function() {
        ...
        var o = this,
            e = o.translucent,
            n = o.inheritedAttributes;
        var r = getIonMode(this);
        var i = this.collapse || "none";
        return h(Host, Object.assign({
            role: "banner",
            class: (t = {}, t[r] = true, t["header-" + r] = true, t["header-translucent"] = this.translucent, t["header-collapse-" + i] = true, t["header-translucent-" + r] = this.translucent, t)
        }, n), r === "ios" && e && h("div", {
                        ...
                        o.gesture = n.sent().createSwipeBackGesture(this.el, (function() {
                            ...
                            if (e.ani) {
                                ...
                                if (!t) {
                                    ...
                                    r += getTimeGivenProgression([0, 0], [1, 0], [.68, .28], [1, 1], o)[0]
                                } else {
                                    r += getTimeGivenProgression([0, 0], [.32, .72], [0, 1], [1, 1], o)[0]
                                }
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                    case 0:
                        ...
                        n = this.activeEl;
                        return [4, attachComponent(this.delegate, this.el, t, ["ion-page", "ion-page-invisible"], o)];
                    case 1:
                        r = i.sent();
                    ...
                    case 2:
                        i.sent();
                        return [4, detachComponent(this.delegate, n)];
                    case 3:
                        i.sent();
                        return [2, true]
                }
            ...
            return __generator(this, (function(d) {
                switch (d.label) {
                    case 0:
                        ...
                        a = this.animated && config.getBoolean("animated", true);
                        s = e.animationBuilder || this.animation || config.get("navAnimation");
                        return [4, transition(Object.assign(Object.assign({
                            mode: i,
                            animated: a,
                            enteringEl: t,
                            leavingEl: o,
...
var ToolbarTitle = function() {
    ...
    t.prototype.render = function() {
        ...
        var e = this.getSize();
        return h(Host, {
            class: createColorClasses(this.color, (t = {}, t[o] = true, t["title-" + e] = true, t["title-rtl"] = document.dir === "rtl", t))
        }, h("div", {
            class: "toolbar-title"
        }, h("slot", null)))
    };
...
var Toolbar = function() {
    ...
    t.prototype.render = function() {
        ...
        return h(Host, {
            class: Object.assign(Object.assign({}, e), createColorClasses(this.color, (t = {}, t[o] = true, t["in-toolbar"] = hostContext("ion-toolbar", this.el), t)))
        }, h("div", {
...
export {
    App as ion_app, Buttons as ion_buttons, Content as ion_content, Footer as ion_footer, Header as ion_header, RouterOutlet as ion_router_outlet, ToolbarTitle as ion_title, Toolbar as ion_toolbar
};